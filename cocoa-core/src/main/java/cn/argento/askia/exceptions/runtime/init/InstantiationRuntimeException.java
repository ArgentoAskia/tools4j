package cn.argento.askia.exceptions.runtime.init;
 ...
 * 因此该异常包括了很多非常详尽的异常信息, 如：诊断信息、起源调查信息、解决方案参考等<br>
 *
 * <b>此异常建议在系统启动的时候抛出, 而非系统运行时抛出, 这也是为何定义此类异常为InitializationException类异常</b>
 *
 * @author Askia
 * @since 1.0
 */
public class InstantiationRuntimeException extends InitializationException {
